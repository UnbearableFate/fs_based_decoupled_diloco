...
def main() -> int:
    ...
    capsules = [load_capsule(backend, key) for key in marker_keys]
    ...
    if any(key not in report.reachable for key in marker_keys):
        raise RuntimeError("live capsule marker is absent from reachability")
    ...
    payload = {
        ...
        "checks": {
            ...
            "capsules_are_reachability_roots": True,
