...
- [存储布局与元数据 / Storage Layout and Metadata](04-storage-and-schema.zh-en.md): 说明 committed log、head、frontier、tensor objects 和导出目录。 / Committed log, head, frontier, tensor objects, and export directories.
...
- [观测、排查与限制 / Operations, Troubleshooting, and Limits](07-operations.zh-en.md): 说明 log verification、恢复检查、常见问题和限制。 / Log verification, recovery checks, troubleshooting, and limitations.
