...
| P0-C002 | Only same-run, causally valid, complete finite proposals may be eligible. | I-004, I-012 | `tests/protocol/test_validation_matrix.py` | M00 proposal catalog; P05 syncer ingest |
| P0-C003 | A single head commit point produces a linear committed prefix. | I-002, I-006 | `tests/reference/test_reference_transitions.py`, `test_crash_prefixes.py` | P04 historical log; M00 production requalification |
...
| P0-C006 | Global recovery equals a complete committed prefix and ignores prepared/orphan state. | I-001, I-008 | `tests/reference/test_crash_prefixes.py` | M00 full replay/RuntimeView rebuild; P07 snapshot+suffix optimization |
